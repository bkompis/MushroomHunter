package cz.muni.fi.pa165.mushrooms.rest;
...
import cz.muni.fi.pa165.mushrooms.rest.mixins.HunterDTOMixin;
...
@ComponentScan(basePackages = {"cz.muni.fi.pa165.mushrooms.rest"})
public class RootWebContext extends WebMvcConfigurerAdapter {
    ...
    public MappingJackson2HttpMessageConverter customJackson2HttpMessageConverter() {
        ...
        objectMapper.addMixInAnnotations(MushroomHunterDTO.class, HunterDTOMixin.class);
